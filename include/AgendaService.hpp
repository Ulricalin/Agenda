...
class AgendaService {
   public:
    ...
    bool ResetPassword(const string username, const string password);

    bool ResetEmail(const string username, const string email);

	bool ResetPhone(const string username, const string phone);
